      ...
      <div className="p-3">
        ...
        <div className="m-2">
          ...
          <div className="mx-56 my-4">
            <button className="bg-blue-500 text-white p-2 flex justify-center w-48 rounded-lg">
              Contribute a reward
            </button>
          </div>
          <div className="my-2">
          ...
          {/* claim button */}
          <button className="bg-blue-500 text-white py-2 justify-center rounded-lg px-6 ml-64">
            Claim
          </button>
        </div>
      </div>
